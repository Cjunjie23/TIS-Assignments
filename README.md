# Assignments
## PC Assemble (Lab)
This lab actually taech us to disassemble a PC then reassemble the PC.It was fun when assemble the PC with my friends.
...
Below is the quiz on PC Assemble :arrow_down:
